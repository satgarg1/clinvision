-- ============================================================
-- Qlinic — migration 056: expose the clinic's own closed_at on
-- get_queue_status()'s return shape
--
-- Why: queue.html already shows a patient "Doctor has closed for the
-- day" using doctorDayClosedAt, but had no way to know the ADMIN had
-- closed the whole clinic for the day (migration 055's
-- clinics.closed_at) — a patient's own doctor might still show
-- available while the clinic itself is closed.
--
-- Purely additive — every existing key stays exactly as-is, this is
-- the same function body as migration 043 with one field added to the
-- final jsonb_build_object.
--
-- Run this once in the Supabase SQL Editor, after
-- 055_clinic_closed_at.sql.
-- ============================================================
